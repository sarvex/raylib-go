...
require (
	...
	github.com/gen2brain/raylib-go/raylib v0.0.0-20230307115054-60f06875ad1a // indirect
	github.com/gen2brain/raylib-go/rres v0.0.0-20230307115054-60f06875ad1a
